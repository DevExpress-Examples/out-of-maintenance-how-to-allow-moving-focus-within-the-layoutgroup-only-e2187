...
Namespace Q157926
    Partial Public Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            DataLayoutControl.FocusHelper = New MyFocusHelper(DataLayoutControl)
        End Sub
    End Class
    ...
    Public Class MyFocusHelper
        ...
        Protected Overrides Function FilterElements(ByVal list As ArrayList, ByVal tabStopOnly As Boolean, ByVal includeReadOnly As Boolean) As ArrayList
            ...
            End If
            'focusedGroup = null;
            Return MyBase.FilterElements(list, tabStopOnly, includeReadOnly)
        End Function

        Protected Overrides Function CheckItem(ByVal item As BaseLayoutItem, ByVal tabStopOnly As Boolean, ByVal includeReadOnly As Boolean) As Boolean
            If focusedGroup IsNot Nothing AndAlso item.Parent IsNot focusedGroup Then
                Return False
            End If
            Return MyBase.CheckItem(item, tabStopOnly, includeReadOnly)
        End Function
    End Class
End Namespace