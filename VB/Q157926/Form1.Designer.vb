...
Namespace Q157926
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' layout
			' 
			Me.layout.Controls.Add(Me.dataNavigator1)
			Me.layout.Controls.Add(Me.lookUpEdit3)
			Me.layout.Controls.Add(Me.lookUpEdit4)
			Me.layout.Controls.Add(Me.ProductIDSpinEdit)
			Me.layout.Controls.Add(Me.ProductNameTextEdit)
			Me.layout.Controls.Add(Me.CategoryIDSpinEdit)
			Me.layout.Controls.Add(Me.SupplierIDSpinEdit)
			Me.layout.Controls.Add(Me.QuantityPerUnitTextEdit)
			Me.layout.Controls.Add(Me.UnitPriceSpinEdit)
			Me.layout.DataSource = Me.productsBindingSource
			Me.layout.Dock = System.Windows.Forms.DockStyle.Fill
			Me.layout.HiddenItems.AddRange(New DevExpress.XtraLayout.BaseLayoutItem() { Me.ItemForProductID, Me.ItemForCategoryID})
			Me.layout.Location = New System.Drawing.Point(0, 0)
			Me.layout.Name = "layout"
			Me.layout.Root = Me.layoutControlGroup1
			Me.layout.Size = New System.Drawing.Size(488, 186)
			...
			Me.dataNavigator1.StyleController = Me.layout
			...
			Me.lookUpEdit3.StyleController = Me.layout
			...
			Me.lookUpEdit4.StyleController = Me.layout
			...
			Me.ProductIDSpinEdit.StyleController = Me.layout
			...
			Me.ProductNameTextEdit.StyleController = Me.layout
			...
			Me.CategoryIDSpinEdit.StyleController = Me.layout
			...
			Me.SupplierIDSpinEdit.StyleController = Me.layout
			...
			Me.QuantityPerUnitTextEdit.StyleController = Me.layout
			...
			Me.UnitPriceSpinEdit.StyleController = Me.layout
